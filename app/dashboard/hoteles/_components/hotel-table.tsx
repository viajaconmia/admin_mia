        ...
        <thead className="bg-gray-50">
          <tr>
            <th
              ...
              onClick={() => onSort?.("tipo_negociacion")}
            >
              Tipo Negociación{" "}
              {sortField === "tipo_negociacion"
                ? sortDirection === "asc"
                  ? "↑"
                  : "↓"
                : ""}
            ...
            <th
              className="px-4 py-2 text-left cursor-pointer"
              onClick={() => onSort?.("Ciudad_Zona")}
            >
              Ciudad{" "}
              {sortField === "Ciudad_Zona"
                ? sortDirection === "asc"
                  ? "↑"
                  : "↓"
                : ""}
            ...
            <th
              className="px-4 py-2 text-left cursor-pointer"
              onClick={() => onSort?.("precio_sencilla")}
            >
              Precio sencilla (Con impuestos){" "}
              {sortField === "precio_sencilla"
                ? sortDirection === "asc"
                  ? "↑"
                  : "↓"
                : ""}
            ...
            <th
              className="px-4 py-2 text-left cursor-pointer"
              onClick={() => onSort?.("precio_doble")}
            >
              Precio doble (Con impuestos){" "}
              {sortField === "precio_doble"
                ? sortDirection === "asc"
                  ? "↑"
                  : "↓"
                : ""}
            ...
            data.map((hotel) => (
              ...
              >
                <td className="px-4 py-2">
                  {quitarAcentos((hotel.tipo_negociacion || "").toUpperCase())}
                </td>
                <td className="px-4 py-2">
                  {quitarAcentos((hotel.nombre || "").toUpperCase())}
                </td>
                <td className="px-4 py-2">
                  {quitarAcentos((hotel.Estado || "").toUpperCase())}
                </td>
                <td className="px-4 py-2">
                  {quitarAcentos((hotel.Ciudad_Zona || "").toUpperCase())}
                </td>
                <td className="px-4 py-2">
                  {getVigenciaLabel(hotel.vigencia_convenio || "")}
                </td>
                <td className="px-4 py-2">
                  {hotel.precio_sencilla !== undefined &&
                  hotel.precio_sencilla !== null &&
                  !isNaN(Number(hotel.precio_sencilla))
                    ? `$ ${Number(hotel.precio_sencilla).toLocaleString(
                        "es-MX",
                ...
                <td className="px-4 py-2">
                  {hotel.precio_doble !== undefined &&
                  hotel.precio_doble !== null &&
                  !isNaN(Number(hotel.precio_doble))
                    ? `$ ${Number(hotel.precio_doble).toLocaleString("es-MX", {
                ...
                <td className="px-4 py-2">
                  {quitarAcentos(hotel.tipo_pago.toUpperCase())}
                </td>
                <td className="px-4 py-2">
