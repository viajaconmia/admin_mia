export const PERMISOS = {
  VISTAS: {
    ...
    MIA_TARJETAS_COMPLETA: "view.mia.tarjetas-completa",
  ...
  COMPONENTES: {
    BOTON: {
      ...
      MIA_TARJETAS_VER_SENSIBLE: "button.mia.tarjetas.ver-sensible",
      ...
      MIA_TITULARES_ELIMINAR: "button.mia.tituelares.eliminar",
